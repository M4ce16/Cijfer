...
function Cijfer(opdracht, cijfer) {
  ...
  opdrCfr.opdracht = opdracht;
  opdrCfr.beschrijving = beschrijving;
}

let cms = new Opdracht('uren', 'tijden', 'klok');
let bap = new Opdracht('java', 'MD1D', 'PHP');
let fro = new Opdracht('007', 'MD1A', 'APP');
